...
7. Set up [Cirun.io](https://docs.cirun.io/quickstart.html) with your fork of the
   repository, and add your AWS credentials in the Cirun console.
8. Set up your git repository to fetch branches from `base` at
...
9. Create a new branch for your task (**no underscores or spaces allowed**). It is best
...
10. Sometimes, changes might be made to the openproblems `base` repository that you want
...
11. Wait for all tests to pass on your new branch before pushing changes (as this will
